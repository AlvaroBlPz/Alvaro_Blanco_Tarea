...
public class VentanaDepart extends JFrame implements ActionListener  {
	...
	private static final String existeDepart = " DEPARTAMENTO EXISTEEE.";
	// WHITE,LIGHTGRAY,GRAY,DARKGRAY,BLUE,BLACK,RED,MAGENTA,PINK,ORANGE,CYAN,GREEN,YELLOW

	private static String deparError = " DEPARTAMENTO ERRÓNEO";
	...
	public VentanaDepart(JFrame f )	{ 	
		...
		getContentPane().add(p0);getContentPane().add(p1);getContentPane().add(p2);getContentPane().add(p3);getContentPane().add(p4);getContentPane().add(p5);getContentPane().add(p7);
	...
	public void modificacion(ActionEvent e) {
		int dep;
		int confirm;
	...
	public void borra(ActionEvent e) {
		int dep;
		int confirm;
